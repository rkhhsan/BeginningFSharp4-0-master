...
let z = raisePowerTwo 12.0
let z2 = raisePowerTwo 4.0
...
let a =SafeUpperCase "Hello"  
SafeUpperCase "Hello iidjhjdjjdkdkkdk"  
SafeUpperCase "Hello hhdhdh jdjdjdjdjjdjdjdkklleyterwqyywyu"  
...
let prefixer = calculatePrefixFunction "DEBUG2"

// Use the prefix function:
printfn "%s" (calculatePrefixFunction "DEBUG4" "My message 6")
printfn "%s" (prefixer "DEBUG2 My message 3")
